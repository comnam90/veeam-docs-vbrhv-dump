...
product: "vbrhv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbrhv/userguide/email_settings.html"
...
1. Select the Suppress notifications until the last job retry check box to receive a notification about the final job status. If you do not select this check box, the Veeam Plug-in for OLVM and RHV will send one notification for every job retry.
2. Click Apply.

|  |
| --- |
| Tip |
| Veeam Plug-in for OLVM and RHV allows you to send a test message to check whether you have configured the settings correctly. To do that, click Test Message. A test message will be sent to the specified email address. |

Configuring Mail Server Settings

To configure mail server settings, choose whether you want to employ [SMTP server](#smtp), [Google Gmail](#google) or [Microsoft 365](#microsoft) authentication for your mail server.
...
[![Configuring Email Notification Settings](images/email_settings_microsoft.webp)](images/email_settings_microsoft.webp "Configuring Email Notification Settings")
